...
const AdminNavbar = () => {
    ...
    return (
        <div className='flex justify-between w-full shadow-lg p-2'>
            {/* left */}
                ...
                <div>
                    <div className='w-8 h-8 rounded-full flex relative items-center justify-center'>
                        <div onClick={() => setClicked(!clicked)}>
                            ...
                            {!hasProfile && <div className='w-8 h-8 rounded-full bg-[#172e59] flex justify-center items-center text-white text-xl cursor-pointer'>G</div>}
                        </div>
